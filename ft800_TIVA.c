...
void ComProgress(int x, int y, int w, int h, int options, int val, int range)
{
...
void ComLineaAngulo(int x, int y, int largo, int ancho, float angulo)
{
    float rad = angulo * 3.14159265 / 180.0; // convertir a radianes

    int x2 = x + (int)(largo * cos(rad));
    int y2 = y - (int)(largo * sin(rad));

    ComLine(x,y,x2,y2,ancho);
}
